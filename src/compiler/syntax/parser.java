...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Aug 18 12:04:28 CEST 2024
  */
      ...
      switch (CUP$parser$act_num)
		...
		Expresion expresion = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			if (!tipoEntero.equals(tipoExpresion)) {
				...
				semanticErrorManager.semanticFatalError("Error, escribeEnt solo acepta parametros de tipo numerico: " + tipoExpresion.getName());
	
			}
			
			
			RESULT = new OpcionesEscribeEnt(lexema);
		...
		Token string = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new OpcionesEscribe(lexema);
		...
		Token semiColon = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new SentenciaSalida(lexema);
		...
		Token semiColon = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new SentenciaLlamadaFuncion(lexema);
		...
		Sentencia sentencia = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new SentenciaMientras(lexema, sentencia.getTiposDevuelve());
		...
		Token closeKey = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			if (!tipoEntero.equals(tipoExpresion)) {
				...
				semanticErrorManager.semanticFatalError("Error, el tipo de la expresion mientras debe ser numerico: " + tipoExpresion.getName());
		...
		RESULT = new PorDefecto(lexema, bloque.getTiposDevuelve());
		...
		RESULT = new CasoAlt(lexema, bloque.getTiposDevuelve());
		...
		RESULT = new CasosAlternativa(lexema, casoAlt.getTiposDevuelve());
		...
		RESULT = new CasosAlternativa(lexema, tiposDevuelveCasosAlternativa, tiposDevuelveCasoAlt);
		...
		if (! tipoEntero.equals(tipoExpresion)) {
			...
			semanticErrorManager.semanticFatalError("Error, el tipo de la alternativa debe ser numerico: " + tipoExpresion.getName());
		...
		RESULT = new SentenciaAlternativas(lexema, tiposDevuelveCasosAlternativa, tiposDevuelvePorDefecto);
		...
		if (!tipoEntero.equals(tipoExpresion)) {
			...
			semanticErrorManager.semanticFatalError("Error, el tipo de la condicion debe ser numerico: " + tipoExpresion.getName());
			
		}
		
		List<TypeIF> tiposDevuelveSi = sentenciaSi.getTiposDevuelve();
	
		RESULT = new SentenciaSi(lexema, tiposDevuelveSi);
		...
		RESULT = new SentenciaSi(lexema, tiposDevuelveSi, tiposDevuelveSino);
		...
		if (!tipoEntero.equals(tipoRef) || !tipoEntero.equals(tipoExpresion)) {
			...
			semanticErrorManager.semanticFatalError("Error, ambos lados de una asignacion suma deben ser de tipo numerico: " + tipoRef.getName() + " , " + tipoExpresion.getName());
			
		} 

		RESULT = new SentenciaAsignacionSuma(lexema);
		...
		RESULT = new Ref(lexema, accesoVector.getTipo());
		...
		String nombreVariable = id.getLexema();
			
		// Comprobar que existe el simbolo
		if (!scopeManager.containsSymbol(nombreVariable)) {
					
			semanticErrorManager.semanticFatalError("Error, variable no encontrada: " + nombreVariable);
		
		}
				
		SymbolIF simbolo = scopeManager.searchSymbol(nombreVariable);
				
		// Comprobar que ref es una variable, y no una constante 
		if (!(simbolo instanceof SymbolVariable)) {
				
			semanticErrorManager.semanticFatalError("Error, la parte izquierda de una asignacion debe ser una variable: " + nombreVariable);
		
		}
				
		RESULT = new Ref(lexema, simbolo.getType());
		...
		if (!tipoRef.equals(tipoExpresion)) {
			...
			semanticErrorManager.semanticFatalError("Error, ambos lados de una asignacion deben tener el mismo tipo: " + tipoRef.getName() + " , " + tipoExpresion.getName());
			
		} 
			
		RESULT = new SentenciaAsignacion(lexema);
		...
		Token semiColon = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				String lexema = id.getLexema() + autoIncremento.getLexema() + semiColon.getLexema();
				...
				if (!tipoEntero.equals(tipoVariable)) {
					...
					semanticErrorManager.semanticFatalError("Error, solo se pueden autoincrementar variables de tipo entero: " + nombreVariable);
				...
				if (!(simbolo instanceof SymbolVariable)) {
					...
					semanticErrorManager.semanticFatalError("Error, solo se pueden autoincrementar variables: " + nombreVariable);
				
				}
				
				RESULT = new SentenciaIncremento(lexema);
		...
		Token semiColon = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				RESULT = new SentenciaDevuelve(lexema, expresion.getTipo());
		...
		Token semiColon = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				RESULT = new SentenciaDevuelve(lexema, tipoVacio);
		...
		RESULT = new Sentencia(lexema, bloque.getTiposDevuelve()); 
		...
		RESULT = new Sentencia(lexema, sentenciaMientras.getTiposDevuelve()); 
		...
		RESULT = new Sentencia(lexema, sentenciaAlternativas.getTiposDevuelve()); 
		...
		RESULT = new Sentencia(lexema, sentenciaSi.getTiposDevuelve()); 
		...
		RESULT = new Sentencia(lexema, Arrays.asList(sentenciaDevuelve.getTipoDevuelve())); 
		...
		Sentencia sentencia = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				Consola.log("listadoSentencias[2]: \n" + lexema);
		 		...
		 		RESULT = new ListadoSentencias(lexema, sentencia.getTiposDevuelve());
		...
		Sentencia sentencia = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				if (UtilsTiposDevuelve.todasLasRamasDevuelven(tiposDevuelveListadoSentencias)) {
					...
					semanticErrorManager.semanticInfo("Aviso, se ha encontrado codigo inalcanzable");
				
					RESULT = new ListadoSentencias(lexema, tiposDevuelveListadoSentencias);
				
				} else {
				
					RESULT = new ListadoSentencias(lexema, tiposDevuelveListadoSentencias, tiposDevuelveSentencia);
		...
		ListadoSentencias listadoSentencias = (ListadoSentencias)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new ContenidoBloque(lexema, listadoSentencias.getTiposDevuelve());
		...
		Token closeParenthesis = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			RESULT = new Bloque(lexema, contenidoBloque.getTiposDevuelve());
		...
		Parametros parametros = (Parametros)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				RESULT = new Parametros(lexema, expresion.getTipo(), parametros.getParametros());
		...
		Expresion expresion = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				RESULT = new Parametros(lexema, expresion.getTipo());
		...
		Token closeKey = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			String lexema = id.getLexema() + openKey.getLexema() + closeKey.getLexema();
			...
			if (!scopeManager.containsSymbol(nombreFuncion)) {
				...
				semanticErrorManager.semanticFatalError("Error, simbolo no encontrado: " + nombreFuncion);
	
			}
			
			SymbolIF simbolo = scopeManager.searchSymbol(nombreFuncion);
			...
			if (!(tipo instanceof TypeProcedure)) {
				...
				semanticErrorManager.semanticFatalError("Error, solo se pueden llamar funciones y procedimientos");
			
			}
				
			if (tipo instanceof TypeFunction) {
			
				semanticErrorManager.semanticFatalError("Error, una llamada a funcion requiere parametros");
			
			} 
			
			RESULT = new LlamadaFuncion(lexema, ((TypeProcedure)tipo).getTipoRetorno());
		...
		Token closeKey = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			String lexema = id.getLexema() + openKey.getLexema() + parametros.getLexema() + closeKey.getLexema();
			...
			if (parametrosFuncion.size() != parametrosExpresion.size()) {
				...
				semanticErrorManager.semanticFatalError("Error, faltan o sobran parametros");
			...
			if (!coincidenLosParametros) {
				...
				semanticErrorManager.semanticFatalError("Error, los parametros no coinciden");
			
			}
			
			RESULT = new LlamadaFuncion(lexema, ((TypeFunction)tipo).getTipoRetorno());
		...
		String lexema = id.getLexema() + openBracket.getLexema() + expresion.getLexema() + closeBracket.getLexema();
		...
		TypeIF tipoEntero = scopeManager.searchType("entero");
 		...
 		if (!tipoEntero.equals(expresion.getTipo())) {
			...
			semanticErrorManager.semanticFatalError("Error, expresion de acceso no es de tipo entero: " + expresion.getTipo().getName());
		}
			
		// Comprobabr que el simbolo del vector existe
		if (!scopeManager.containsSymbol(nombreVector)) {
		
			semanticErrorManager.semanticFatalError("Error, simbolo no definido: " + nombreVector);
		}
		
		SymbolIF simboloVector = scopeManager.searchSymbol(nombreVector);
		...
		if (!(tipoVector instanceof TypeArray)) {
			...
			semanticErrorManager.semanticFatalError("Error, expresion de acceso solo permitida sobre vectores");
		
		}
		
		TypeIF tipoElemento = ((TypeArray)tipoVector).getTipoElemento();
	
		RESULT = new AccesoVector(lexema, tipoElemento);
    	...
    	Consola.log("expresion[12]: \n" + lexema);
 		...
 		RESULT = new Expresion(lexema, llamadaFuncion.getTipoRetorno());
    	...
    	Consola.log("expresion[11]: \n" + lexema);
 		...
 		RESULT = new Expresion(lexema, accesoVector.getTipo());
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
 		...
 		String lexema = e1.getLexema() + " " + andLogica.getLexema() + " " + e2.getLexema();
		...
		TypeIF tipoEntero = scopeManager.searchType("entero");
 		...
 		if (!tipoEntero.equals(e1.getTipo()) || !tipoEntero.equals(e2.getTipo())) {
 		
			semanticErrorManager.semanticFatalError("Error, expresion no es de tipo entero: " + e1.getTipo().getName() + " && " + e2.getTipo().getName());
			
 		} 		
			
		RESULT = new Expresion(lexema, tipoEntero);
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
 		...
 		String lexema = e1.getLexema() + " " + equal.getLexema() + " " + e2.getLexema();
		...
		String lexema = e1.getLexema() + " " + lowerThan.getLexema() + " " + e2.getLexema();
		...
		TypeIF tipoEntero = scopeManager.searchType("entero");
 		...
 		if (!tipoEntero.equals(expresion.getTipo())) {
			...
			semanticErrorManager.semanticFatalError("Error, expresion no es de tipo entero: !" + expresion.getTipo().getName());
		...
		String lexema = e1.getLexema() + " " + mult.getLexema() + " " + e2.getLexema();
		...
		String lexema = e1.getLexema() + " " + plus.getLexema() + " " + e2.getLexema();
		...
		RESULT = new Expresion(lexema, expresion.getTipo());
    	...
    	Consola.log("expresion[2]: \n" + lexema);
	 	...
	 	if (!scopeManager.containsSymbol(nombre)) {
			...
			semanticErrorManager.semanticFatalError("Error, variable no definida: " + nombre);
	 	
	 	} 
	 	
 		RESULT = new Expresion(lexema, scopeManager.searchSymbol(nombre).getType());
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			String lexema = tipo.getLexema() + " " + id.getLexema(); 
		
        	Consola.log("parametro[2]: \n" + lexema);
			
			TypeIF tipoParametro = scopeManager.searchType(tipo.getLexema());
			
			RESULT = new Parametro(lexema, tipoParametro, id.getLexema());
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			String lexema = entero.getLexema() + " " + id.getLexema(); 

        	Consola.log("parametro[1]: \n" + lexema);
			
			TypeIF tipoEntero = scopeManager.searchType("entero");
			
			RESULT = new Parametro(lexema, tipoEntero, id.getLexema());
		...
		Token closeParenthesis = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				RESULT = Funcion1.produccion_seccionVariables_listadoSentencias_closeParenthesis(seccionVariables, listadoSentencias, closeParenthesis);
		...
		Token closeParenthesis = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				RESULT = Funcion1.produccion_listadoSentencias_closeParenthesis(listadoSentencias, closeParenthesis);
